# SCOTUS-Stevens: Decision.fctr classification: Decision Tree
bdanalytics  
...
![](stevens_glm_binomial_alpha_fctr_files/figure-html/set_global_options-1.png) 
...
![](stevens_glm_binomial_alpha_fctr_files/figure-html/inspect_explore_data_1-1.png) 
...
![](stevens_glm_binomial_alpha_fctr_files/figure-html/extract_features-1.png) 
...
![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-1.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-2.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-3.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-4.png) 
...
![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-5.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-6.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-7.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-8.png) 
...
![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-9.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-10.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-11.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-12.png) 
...
![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-13.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-14.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-15.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-16.png) 
...
![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-17.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-18.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-19.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-20.png) 
...
```r
glb_glm_mdl <- ret_lst[["model"]]; glb_glm_mdl_fn <- ret_lst[["model_fn"]]
...
![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-21.png) 
...
![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-22.png) 

```r
glb_rf_mdl <- ret_lst[["model"]]; glb_rf_mdl_fn <- ret_lst[["model_fn"]]
# glb_sel_mdl <- ret_lst[["model"]]; glb_sel_mdl_fn <- ret_lst[["model_fn"]]
...
##   predicted class=R  expected loss=0.4545455  P(node) =1
...
##   predicted class=A  expected loss=0.3945946  P(node) =0.4671717
##     class counts:   112    73
...
##   predicted class=R  expected loss=0.3222749  P(node) =0.5328283
##     class counts:    68   143
...
##   predicted class=A  expected loss=0.2089552  P(node) =0.1691919
##     class counts:    53    14
##    probabilities: 0.791 0.209 
## 
## Node number 5: 118 observations,    complexity param=0.05277778
##   predicted class=A  expected loss=0.5  P(node) =0.2979798
##     class counts:    59    59
...
##   predicted class=R  expected loss=0.4050633  P(node) =0.3989899
##     class counts:    64    94
...
##   predicted class=R  expected loss=0.0754717  P(node) =0.1338384
##     class counts:     4    49
##    probabilities: 0.075 0.925 
## 
## Node number 10: 33 observations
##   predicted class=A  expected loss=0.2121212  P(node) =0.08333333
##     class counts:    26     7
##    probabilities: 0.788 0.212 
## 
## Node number 11: 85 observations,    complexity param=0.01666667
##   predicted class=R  expected loss=0.3882353  P(node) =0.2146465
##     class counts:    33    52
...
##   predicted class=R  expected loss=0.475  P(node) =0.3030303
##     class counts:    57    63
...
##   predicted class=R  expected loss=0.1842105  P(node) =0.0959596
##     class counts:     7    31
##    probabilities: 0.184 0.816 
## 
## Node number 22: 29 observations
##   predicted class=A  expected loss=0.4482759  P(node) =0.07323232
##     class counts:    16    13
##    probabilities: 0.552 0.448 
## 
## Node number 23: 56 observations
##   predicted class=R  expected loss=0.3035714  P(node) =0.1414141
##     class counts:    17    39
##    probabilities: 0.304 0.696 
## 
## Node number 24: 25 observations
##   predicted class=A  expected loss=0.24  P(node) =0.06313131
##     class counts:    19     6
##    probabilities: 0.760 0.240 
## 
## Node number 25: 95 observations
##   predicted class=R  expected loss=0.4  P(node) =0.239899
##     class counts:    38    57
...
##    2) LowerCourt.fctr=liberal 185  73 A (0.6054054 0.3945946)  
##      4) Respondent.fctr=CRIMINAL.DEFENDENT,INJURED.PERSON,POLITICIAN,STATE,US 67  14 A (0.7910448 0.2089552) *
##      5) Respondent.fctr=BUSINESS,CITY,EMPLOYEE,AMERICAN.INDIAN,GOVERNMENT.OFFICIAL,OTHER 118  59 A (0.5000000 0.5000000)  
##       10) Petitioner.fctr=CITY,EMPLOYEE,GOVERNMENT.OFFICIAL,EMPLOYER,POLITICIAN 33   7 A (0.7878788 0.2121212) *
##       11) Petitioner.fctr=BUSINESS,INJURED.PERSON,OTHER,STATE,US 85  33 R (0.3882353 0.6117647)  
##         22) Circuit.fctr=FED,DC,3rd,10th,4th,1st 29  13 A (0.5517241 0.4482759) *
##         23) Circuit.fctr=9th,7th,11th,2nd,6th,8th,5th 56  17 R (0.3035714 0.6964286) *
##    3) LowerCourt.fctr=conser 211  68 R (0.3222749 0.6777251)  
##      6) Respondent.fctr=BUSINESS,CITY,CRIMINAL.DEFENDENT,EMPLOYEE,GOVERNMENT.OFFICIAL,OTHER,US 158  64 R (0.4050633 0.5949367)  
##       12) Circuit.fctr=9th,7th,FED,DC,11th,6th,3rd,10th,8th 120  57 R (0.4750000 0.5250000)  
##         24) Issue.fctr=DueProcess,FederalismAndInterstateRelations,FirstAmendment,FederalTaxation,Unions 25   6 A (0.7600000 0.2400000) *
##         25) Issue.fctr=EconomicActivity,JudicialPower,CriminalProcedure,CivilRights,Privacy,Attorneys 95  38 R (0.4000000 0.6000000) *
##       13) Circuit.fctr=2nd,5th,4th 38   7 R (0.1842105 0.8157895) *
##      7) Respondent.fctr=EMPLOYER,AMERICAN.INDIAN,INJURED.PERSON,POLITICIAN,STATE 53   4 R (0.0754717 0.9245283) *
```
...
![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-23.png) 
...
![](stevens_glm_binomial_alpha_fctr_files/figure-html/run_models-24.png) 
...
![](stevens_glm_binomial_alpha_fctr_files/figure-html/fit.data.training.all-1.png) 
...
![](stevens_glm_binomial_alpha_fctr_files/figure-html/fit.data.training.all-2.png) 
...
![](stevens_glm_binomial_alpha_fctr_files/figure-html/fit.data.training.all-3.png) 
...
![](stevens_glm_binomial_alpha_fctr_files/figure-html/fit.data.training.all-4.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/fit.data.training.all-5.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/fit.data.training.all-6.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/fit.data.training.all-7.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/fit.data.training.all-8.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/fit.data.training.all-9.png) 
...
![](stevens_glm_binomial_alpha_fctr_files/figure-html/fit.data.training.all-10.png) 
...
![](stevens_glm_binomial_alpha_fctr_files/figure-html/fit.data.training.all-11.png) 
...
![](stevens_glm_binomial_alpha_fctr_files/figure-html/predict.data.new-1.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/predict.data.new-2.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/predict.data.new-3.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/predict.data.new-4.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/predict.data.new-5.png) ![](stevens_glm_binomial_alpha_fctr_files/figure-html/predict.data.new-6.png) 
...
![](stevens_glm_binomial_alpha_fctr_files/figure-html/predict.data.new-7.png) 
...
![](stevens_glm_binomial_alpha_fctr_files/figure-html/predict.data.new-8.png) 
